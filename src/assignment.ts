...
export const setStoredAssignments = (assignments: Plannable[]) => setStorage({assignments});
export const setStoredUserAssignments = (userAssignments: Plannable[]) => setStorage({userAssignments});
